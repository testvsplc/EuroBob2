...
// STYLES
import styles from '../../rides/styles/searchLocation';

// ACTIONS
import { addLocationToFavoritesRequest, removeLocationToFavoritesRequest, setFromLocation, setToLocation, setStopLocation, fetchPredictions, fetchPredictionPlace, fetchPlaceAndCreateFavorite } from '../../rides/';
import { toggleSearch, startStateRefresh, stopStateRefresh, setUpSearch } from '../../../utility/';
...
class LocationsDemo extends Component {
    static renderNavigationBar (props) {
        ...
        return (
            <Header
                ...
                title={props.title}
                search={true}
                onSearchSubmit={(query) => dispatch(fetchPredictions(query))}
            />
        );
    }
    ...
    renderCurrentLocation () {
        ...
        return this.renderSearches([currentLocation]);
    }

    render () {
        const { locations, searching, isRefreshing } = this.props;
            ...
            >
                {searching ?
                    <View style={styles.locationCard}>
                        {this.renderSearches(locations.searchResults)}
                    </View>
                :
                    <View>
                        <View style={styles.locationCard}>
...
export default connect(select)(LocationsDemo);
